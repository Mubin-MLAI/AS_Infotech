...
class Item(models.Model):
    ...
    slug = AutoSlugField(unique=True, populate_from='name')
    name = models.CharField(max_length=50)
    serialno = models.CharField(max_length=50, unique=True, null=True)
    ...
    hdd_qty = models.PositiveIntegerField(default=1)
    ssd = models.ForeignKey(Sdd, on_delete=models.CASCADE)
    ssd_qty = models.PositiveIntegerField(default=1)
    smps = models.ForeignKey(Smps, on_delete=models.CASCADE, null=True, blank=True)
    smps_status = models.CharField(max_length=50, choices=STATUS_CHOICES, default='available')
    smps_replacement_description = models.TextField(null=True, blank=True)
    ...
    motherboard_replacement_description = models.TextField(null=True, blank=True)
